    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!isMultiPart) {
                ...
                int idP = Integer.valueOf((String) params.get("id"));
                ...
                Product proOld = pm.getOneProduct(idP);
                if(fileName == null || fileName.isEmpty()){
                    fileName = proOld.getImageLink();
                }
                
                boolean isCheck = pm.updateProduct(new Product(idP, name, categoryId, price, proOld.getDescription(), quantity, status, fileName, null));
                if (isCheck) {
